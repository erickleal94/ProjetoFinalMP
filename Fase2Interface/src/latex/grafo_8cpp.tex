...
Definição na linha 767 do arquivo grafo.\+cpp.
...
Definição na linha 565 do arquivo grafo.\+cpp.
...
Definição na linha 664 do arquivo grafo.\+cpp.
...
{\em meu\+\_\+grafo} & -\/ Deve ser passado um ponteiro para um grafo inicializado \\
\hline
{\em nome} & -\/ Deve ser passado uma string de até 100 caracteres, mais o caracter zero terminal. Se a string tiver mais que 100 caracteres, o vértice não será encontrado, uma vez que 100 é o maior número de caracteres que um vértice pode ter.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Retorna}
...
O grafo já deve ter sido inicializado por \hyperlink{grafo_8h_a3e61bf2ada0f9af7e2e9883241496606}{criar\+\_\+grafo()}, se não for o programa pode ser interrompido. strlen(nome) $<$= 100 Assertivas de saída O retorno será T\+R\+U\+E ou F\+A\+L\+S\+E O conteúdo do grafo e da string passados não serão modificados 
...
Definição na linha 637 do arquivo grafo.\+cpp.
...
Definição na linha 735 do arquivo grafo.\+cpp.
...
Definição na linha 720 do arquivo grafo.\+cpp.
